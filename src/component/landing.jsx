        ...
        <section className="mt-40 sm:mt-32    pt-24 bg-[#1d2435] ">
            <div className="container">
                <div className="w-[750px] max-w-full mx-auto">
                    <img src="./src/assets/images/illustration-intro.png" className="w-full h-fit" alt="laning-img" />
                </div>
            ...
            <img src="./src/assets/images/bg-curvy-desktop.svg" className="h-[250px] w-full" alt="" />
        </section>
    )
}
